...
%global pkg_name python_cmake_module
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-python-cmake-module
Version:        0.12.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Shane Loretz <sloretz@openrobotics.org> - 0.12.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Shane Loretz <sloretz@openrobotics.org> - 0.12.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Shane Loretz <sloretz@openrobotics.org> - 0.12.0-1
- Autogenerated by Bloom
